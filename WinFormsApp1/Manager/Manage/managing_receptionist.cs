...
namespace WinFormsApp1
{
    public partial class managing_receptionist : Form
    {
        ...
        private void search_button_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = controller.searchForReceptionistsByName(employee_name_tb.Text);
        ...
        private void employee_name_tb_KeyPress(object sender, KeyPressEventArgs e)
        {
            // chars only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsDigit(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }

        private void employee_SSN_tb_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Positive int numbers only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsLetter(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }

        private void managerSSN_tb_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Positive int numbers only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsLetter(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }

        private void employee_phone_number_tb_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Positive int numbers only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsLetter(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }
