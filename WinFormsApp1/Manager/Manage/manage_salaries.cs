...
namespace WinFormsApp1
{
    public partial class Manage_Salaries : Form
    {
        ...
        private void salary_SSN_db_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void salary_gross_db_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Positive int numbers only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsLetter(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }

        private void salary_taxes_db_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Positive int numbers only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsLetter(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }

        private void salary_bonus_db_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Positive int numbers only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsLetter(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }

        private void salary_penalty_db_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Positive int numbers only
            e.Handled = e.KeyChar == '-' || e.KeyChar == '.' || char.IsLetter(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar);
        }
